  ...
  const skillCategories = [
    {
      ...
      icon: Code2,
      color: "text-blue-500",
      skills: ["c#", "Java", "PHP", "SQL", "HTML", "CSS", "JavaScript", "TypeScript"]
    },
    {
      title: "Frameworks & Libraries",
      icon: Globe,
      color: "text-green-500",
      skills: [".NET Core", "ASP.NET", "Angular", "React", "Next.js", "Vue"]
    },
    {
      title: "Database & Data Management",
      icon: Database,
      color: "text-purple-500",
      skills: ["MS SQL", "MySQL", "MongoDB", "Firebase", "phpMyAdmin", "Database Design"]
    },
    {
      title: "Development Tools",
      icon: Wrench,
      color: "text-orange-500",
      skills: ["Git", "GitHub", "CI/CD", "Docker", "Postman", "Visual Studio", "VS Code", "XAMPP"]
    },
    {
      title: "Core Concepts",
      icon: Brain,
      color: "text-red-500",
      skills: ["Object-Oriented Programming", "CRUD Operations", "Authentication", "API Development", "Active Directory"]
    }
  ];
